...
이 프로젝트는 블록체인 합의 알고리즘에 대한 엄밀한 이론적 검증과 함께 개발되었습니다.

- **[성능 분석 레포지토리 (blockchain-test)](https://github.com/capstone-design2-agora/blockchain-test)**: 
  - Raft, IBFT, QBFT 알고리즘의 트랜잭션 처리량(TPS)과 지연 시간(Latency)을 비교 분석한 실험 데이터를 포함합니다.
  - 본 투표 시스템의 최적 합의 엔진을 선정하기 위한 데이터 기반 근거를 제공합니다.

- **관련 학술 논문 (`KSC2025_투표.pdf`)**: 
  - 시스템 아키텍처와 성능 분석 결과를 종합하여 KSC 2025에 발표된 논문입니다.
  - 이론적 실험 결과를 바탕으로 시스템의 신뢰성을 확보하였습니다.
